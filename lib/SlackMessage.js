...
var SlackMessage = (function () {
  ...
  _createClass(SlackMessage, [{
    ...
    key: 'unshiftMessage',
    value: function unshiftMessage(message) {
      this.messages.unshift(message);
    }
  }, {
    key: 'sendMessage',
    value: function sendMessage(message, icon) {
      var slackProperties = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];

      this.slack.webhook(Object.assign({
        channel: _config2['default'].channel,
        username: _config2['default'].username,
        icon_emoji: icon || _config2['default'].icon,
        text: message
    ...
    value: function sendTestReport(nrFailedTests) {
      this.sendMessage(this.getTestReportMessage(), nrFailedTests === 0 ? ":white_check_mark:" : ":poop:", nrFailedTests > 0 && this.loggingLevel === _constLoggingLevels2['default'].TEST ? {
        "attachments": [{
          color: 'danger',
